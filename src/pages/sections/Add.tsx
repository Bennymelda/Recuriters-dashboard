...
const Add = () => {
    return ( <>
<section className=" max-w-container-max mx-auto ter overflow-hidden mb-20 md:mt-20 ">
<div className="bg-[#285A48] dark:bg-[#B0E4CC] p-10 rounded-[2rem] p-lg lg:p-xl flex flex-col lg:flex-row items-center gap-10 relative">
